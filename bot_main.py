...
TOKEN = os.getenv('873656324:AAFqF5d_0oAMgN2F2XPW5xMjrGULZvUnZTI')  # Press "Reveal Config Vars" in settings tab on Heroku and set TOKEN variable
PROJECT_NAME = os.getenv('tel-bot-python')  # Set it as you've set TOKEN env var
